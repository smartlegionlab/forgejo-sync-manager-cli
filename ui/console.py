...
class ConsoleUI:
    ...
    def show_about():
        ...
        print("  Repository: https://github.com/smartlegionlab/forgejo-sync-manager-cli")
        print("  Disclaimer: https://github.com/smartlegionlab/forgejo-sync-manager-cli/blob/master/DISCLAIMER.md")
        print("─" * 50)
        input("\nPress Enter to continue...")
